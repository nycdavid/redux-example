...
var masterReducer = (0, _redux.combineReducers)({ inputTextState: inputTextState });
var store = (0, _redux.createStore)(masterReducer);
...
var _Brother = __webpack_require__(70);

var _Brother2 = _interopRequireDefault(_Brother);

var _Sister = __webpack_require__(71);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Brother2.default, null),
        _react2.default.createElement(_Sister2.default, null)
      );
    }
  }]);
...
var Brother = function (_React$Component) {
  _inherits(Brother, _React$Component);

  function Brother(props) {
    _classCallCheck(this, Brother);

    return _possibleConstructorReturn(this, (Brother.__proto__ || Object.getPrototypeOf(Brother)).call(this, props));
  }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'text', onChange: function onChange(evt) {
            _this2.props.onTextChange(evt.target.value);
          } })
      );
    }
  }]);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Brother);
...
function mapStateToProps(state) {
  var inputTextState = state.inputTextState;
  return {
